...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Property Pulse Check — CRE OM Risk Screening" },
      ...
      { property: "og:title", content: "Property Pulse Check — CRE OM Risk Screening" },
      ...
      { name: "twitter:title", content: "Property Pulse Check — CRE OM Risk Screening" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Instrument+Serif:ital@0;1&family=JetBrains+Mono:wght@400;500&family=Great+Vibes&display=swap",
      },
    ],
  }),
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <Link to="/" className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary text-primary-foreground">
            <span className="font-script text-xl leading-none">P</span>
          </div>
          <div className="leading-tight">
            <div className="font-script text-2xl leading-none text-foreground">Property Pulse Check</div>
            <div className="text-[9px] uppercase tracking-[0.18em] text-muted-foreground">CRE deal screening</div>
          </div>
        </Link>
